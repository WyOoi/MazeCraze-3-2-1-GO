...
//sensor 1 pins
const int trigPin1 = 15;const int echoPin1 = 2;

//sensor 2 pins
const int trigPin2 = 5;const int echoPin2 = 18;

//sensor 3 pins : front sensor
const int trigPin3 = 6;const int echoPin3 = 2;

//right motor pins
const int in1R = 7;const int in2R = 8;const int enR = 9;

//left motor pins
const int in1L = 4;const int in2L = 5;const int enL = 3;
...
void loop() {
  ...
  //   Serial.println(speedL);
  //   Serial.println(speedR);
  //   // analogWrite(enL, speedL);analogWrite(enR, speedR);
